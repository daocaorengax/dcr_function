  ...
  var ecDo = {
     ...
     * 去除空格
     * @param {*} str 
     * @param {*} type 1-所以空格 2-前后空格 3-前空格 4-后空格
     * trim('   123sds',1)
     * result :123sds
     */
     ...
     * ecDo.replaceAll('这里是上海，中国第三大城市，上海省省会，简称穗，','上海','广州')
     ...
     * @param {*} str 
     * @param {*} regArr 
     * @param {*} type  0.依次从前面开始替换的个数  1.从最后一个开始替换的个数
     * @param {*} ARepText 
     ...
     * var str='asd    654a大蠢sasdasdASDQWEXZC6d5#%^*^&*^%^&*$\\"\'#@!()
     * filterStr(str,'html,WORD,chinese,special','*','%?')
     * result："asd    654a**sasdasd*********6d5#%^*^&*^%^&*$\"'#@!()
     * @param {*} str 
     * @param {*} type 
     * @param {*} restr 
     * @param {*} spstr 
